...
(function(root, factory) {
  ...
  return function(lunr, nodejiebaDictJson) {
    ...
    lunr.zh.stopWordFilter = lunr.generateStopWordFilter(
      '的 一 不 在 人 有 是 為 為 以 於 於 上 他 而 後 後 之 來 來 及 了 因 下 可 到 由 這 這 與 與 也 此 但 並 並 個 個 其 已 無 無 小 我 們 們 起 最 再 今 去 好 只 又 或 很 亦 某 把 那 你 乃 它 吧 被 比 別 趁 當 當 從 從 得 打 凡 兒 兒 爾 爾 該 該 各 給 給 跟 和 何 還 還 即 幾 幾 既 看 據 據 距 靠 啦 另 麽 麼 每 嘛 拿 哪 您 憑 憑 且 卻 卻 讓 讓 仍 啥 如 若 使 誰 誰 雖 雖 隨 隨 同 所 她 哇 嗡 往 些 向 沿 喲 喲 用 咱 則 則 怎 曾 至 致 著 著 諸 諸 自'.split(' '));
